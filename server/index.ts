...
import { initializeSqliteDatabase } from '../src/storage/sqlite/initialize'
import type { SqlStatement } from '../src/storage/types'

const projectRoot = resolve(dirname(fileURLToPath(import.meta.url)), '..')
const staticRoot = resolve(projectRoot, 'dist')
const databasePath = resolve(
  process.env.AMOYA_DB_PATH || resolve(projectRoot, 'data/amoya_project_forecast.db'),
)
